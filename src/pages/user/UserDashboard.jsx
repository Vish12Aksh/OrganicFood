                ...
                <div className="top">
                    <div className="bg-pink-50 py-5 rounded-xl border border-pink-100">
                        ...
                        <div className="flex justify-center">
                            <img src="https://cdn-icons-png.flaticon.com/128/2202/2202112.png" alt="UD1" />
                        </div>
                        {/* text  */}
                        <div className="">
                        ...
                        return (
                            <div key={index} className="">
                                {order.carditems.map((item, index) => {
                                    ...
                                    const { status } = order
                                    return (
                                        <div key={index} className="mt-5 flex  overflow-hidden rounded-xl border border-pink-100 ">
                                                ...
                                                <div className="p-8">
                                                    <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-1">
                                                        ...
                                                        <div className="mb-4">
                                                            ...
                                                            <div className="text-sm font-semibold text-green-800 ">{order.status}</div>
                                                        </div>
                                            ...
                                            <div className="flex-1">
                                                <div className="p-8">
                                                    <div className="-m-7 divide-y divide-green-200">
                                                        {
