            ...
            <div className='container mx-auto px-5 py-10 md:py-14'>
                ...
                <div className="flex flex-wrap -m-4 text-center">
                    ...
                    <div className="p-4 md:w-1/3 sm:w-1/2 w-full">
                        <div className='border-2 hover:shadow-xl hover:shadow-green-200 border-green-200 bg-gray-100 shadow-[inset_0_0_2px_rgba(0,0,0,0.6)] px-4 py-6 rounded-lg'>
                            <svg className='text-pink-600 w-12 h-12 mb-3 inline-block'
